...
# for loop
# executes a set of statement as it iterates a collection or sequence
def basic_for(arg):
    for alpha in arg:
        print(alpha)
...
# Nested for loop
# You can have a loop inside another loop. The inner loop can use the variable
...
# Break statement
# This is used in conjunction with an if statement to break for a loop
# While loop
